 ...
 * @Author: guojiecheng
 * @LastEditTime: 2024-08-16 11:42:39
 * @LastEditors: guojiecheng
-->
<template>
    <view class="px-5 py-2">
        <base-form :legend="[
            { label: '新密码', key: 'oldPassword', props: { type: 'password' }, required: true },
            { label: '新密码', key: 'password', props: { type: 'password' } , required: true },
            { label: '确认密码', key: 'confirmPassword', props: { type: 'password' }, required: true },
