<!--
 * @Date: 2024-07-25 15:40:08
 * @Author: guojiecheng
 * @LastEditTime: 2024-07-25 15:42:11
 * @LastEditors: guojiecheng
-->
<template>
    <view class="h100p">
        <uv-tabs :list="[
            { name: '我的竞拍', status: 'MAKING' },
            { name: '我的拼单', status: 'APPROVED' },
            { name: '订单合并', status: 'CLOSED' }
        ]" lineColor="#e42112" itemStyle="padding-left: 20px; padding-right: 20px; height: 44px;"></uv-tabs>
        <view class="list">
            <base-list :url="api.ecexOrderHeaderController_findHeaderAndLineCustomPage" :params="formData" ref="list">
